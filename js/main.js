...
window.addEventListener('scroll', () => {
    ...
    planet2.style.marginTop  = value * 0.6 + 'px';
    header_text.style.marginTop = value * 0.45 + 'px';

    top_building.style.transition = "0.8s ease";
    middle_building.style.transition = "0.8s ease";
    small_building.style.transition = "0.8s ease";
